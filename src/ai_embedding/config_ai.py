...
AI_CONFIG_PATH = Path(os.path.join(
    _AI_DIR, AI_CONFIG_JSON_NAME)).resolve()
AI_DOCUMENTS_PATH = Path(os.path.join(
    _AI_DIR, AI_DOCUMENTS_JSON_NAME)).resolve()
AI_CHUNK_PATH = Path(os.path.join(
    _AI_DIR, AI_CHUNKS_JSONL_NAME)).resolve()
AI_MANIFEST_PATH = Path(os.path.join(
    _AI_DIR, AI_MANIFEST_JSON_NAME)).resolve()
