...
1. **MikTeX**: serve ad avere LateX installato e nel path
2. **Pandoc** (<=3.7.0.1): serve a convertire da .tex a .pdf (da inserire negli env Path)
...
4. Stroberry Perl: anche questo da inserire nei path di sistema
